...
#define GAME_INITIALIZE(name) \
  void name(game_memory_t* memory, game_offscreen_buffer_t* buffer)
...
#define GAME_GET_SOUND_SAMPLES(name) \
  void name(game_memory_t* memory, game_sound_output_buffer_t* sound_buffer)
