...
internal void draw_line(game_offscreen_buffer_t *buffer, point_i32_t A, point_i32_t B, color_t color) {
...
internal void draw_buffer(game_offscreen_buffer_t *dest_buffer, i32 X, i32 Y, const game_offscreen_buffer_t *source_buffer) {
    i32 min_x = X;
    i32 min_y = Y;
